        ...
        <div className="background-banner py-5">
          <div className="row">
            <div className="content">
              ...
              <h2 className="fw-bold" style={{ color: "#16205F" }}>
                Easy Process
              </h2>
              <div className="paragraph">
                <p>
                  We specialize in helping you build a team of expert
                  developers, testers, and leaders.
                </p>
              </div>
            </div>
          </div>
      ...
      <Modal show={showModal} onHide={closeModal} centered size="lg">
        <Modal.Header closeButton>
          <Modal.Title>
            <h2
              className="fw-bold"
              style={{ color: "#16205F", fontSize: "46px" }}
            >
              Build a Team
            </h2>
            <p style={{ color: "#16205F", fontSize: "18px" }}>
